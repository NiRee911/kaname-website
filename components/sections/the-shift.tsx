export function TheShift() {
  return (
    <section className="border-y border-slate-800 px-6 py-20 text-center md:px-16">
      <p className="mb-6 text-[10px] font-semibold tracking-[3px] text-slate-600 uppercase">
        The Shift
      </p>
