export function Hero() {
  return (
    <section className="relative overflow-hidden px-6 py-24 md:px-16 md:py-36">
      <div className="pointer-events-none absolute -right-24 -top-24 h-[480px] w-[480px] rounded-full bg-[radial-gradient(circle,_#f59e0b15,_transparent_70%)]" />
      <div className="relative mx-auto max-w-5xl">
        <p className="mb-5 text-[10px] font-semibold tracking-[4px] text-amber-400 uppercase">
        ...
        <div className="mb-6 flex items-baseline gap-4">
          ...
          <span className="text-4xl font-light text-amber-400/70">要</span>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="#download"
            className="rounded bg-amber-400 px-5 py-2.5 text-[11px] font-bold tracking-widest text-[#0f172a] uppercase transition-colors hover:bg-amber-300"
          >
            Read the Guide
          </a>
          <a
